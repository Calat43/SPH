...
void explicit_scheme(ParticleParams gas_params, ParticleParams dust_params, ProblemParams problem_params)
{
    ...
    sprintf(fileName, "%s/explicit_gas_d2g=%lf_h=%lf_tau=%lf_T=%lf_K=%lf.dat", DATA_DIR,
    ...
    sprintf(fileName, "%s/explicit_dust_d2g=%lf_h=%lf_tau=%lf_T=%lf_K=%lf.dat", DATA_DIR,
            problem_params.d2g, problem_params.h, problem_params.tau, problem_params.T, problem_params.K);
    ...
    sprintf(fileName, "%s/explicit_gas_T_d2g=%lf_h=%lf_tau=%lf_T=%lf_K=%lf.dat", DATA_DIR,
            problem_params.d2g, problem_params.h, problem_params.tau, problem_params.T, problem_params.K);
    ...
    sprintf(fileName, "%s/explicit_dust_T_d2g=%lf_h=%lf_tau=%lf_T=%lf_K=%lf.dat", DATA_DIR,
            problem_params.d2g, problem_params.h, problem_params.tau, problem_params.T, problem_params.K);
